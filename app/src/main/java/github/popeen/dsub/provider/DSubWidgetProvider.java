...
import github.popeen.dsub.service.DownloadServiceLifecycleSupport;
...
public class DSubWidgetProvider extends AppWidgetProvider {
     ...
     *
     * @param playerActive @param playerActive True if player is active in background.  Launch {@link github.popeen.dsub.activity.SubsonicFragmentActivity}.
     */
