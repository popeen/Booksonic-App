...
public final class Constants {
	...
	public static final String PREFERENCES_KEY_PODCAST_PLAYLIST_ENABLED = "podcastPlaylistEnabled";
    ...
    public static final String PREFERENCES_FILE_NAME = "github.popeen.dsub_preferences";
	public static final String OFFLINE_SYNC_NAME = "github.popeen.dsub.offline";
	...
	public static final String SYNC_ACCOUNT_TYPE = "booksonic.popeen.com";
	public static final String SYNC_ACCOUNT_PLAYLIST_AUTHORITY = "github.popeen.dsub.playlists.provider";
	public static final String SYNC_ACCOUNT_PODCAST_AUTHORITY = "github.popeen.dsub.podcasts.provider";
	public static final String SYNC_ACCOUNT_STARRED_AUTHORITY = "github.popeen.dsub.starred.provider";
	public static final String SYNC_ACCOUNT_MOST_RECENT_AUTHORITY = "github.popeen.dsub.mostrecent.provider";
