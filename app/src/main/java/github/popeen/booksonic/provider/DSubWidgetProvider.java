 ...
 */
package github.popeen.booksonic.provider;
...
import github.popeen.booksonic.service.DownloadServiceLifecycleSupport;
...
public class DSubWidgetProvider extends AppWidgetProvider {
     ...
     *
     * @param playerActive @param playerActive True if player is active in background.  Launch {@link SubsonicFragmentActivity}.
     */
