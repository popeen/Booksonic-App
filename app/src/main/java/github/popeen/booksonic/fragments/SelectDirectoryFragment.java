...
import github.popeen.booksonic.adapter.AlphabeticalAlbumAdapter;
import github.popeen.booksonic.adapter.EntryGridAdapter;
import github.popeen.booksonic.adapter.EntryInfiniteGridAdapter;
import github.popeen.booksonic.adapter.SectionAdapter;
import github.popeen.booksonic.adapter.TopRatedAlbumAdapter;
...
import github.popeen.booksonic.util.BookInfoAPI;
import github.popeen.booksonic.util.Constants;
import github.popeen.booksonic.util.DrawableTint;
import github.popeen.booksonic.util.ImageLoader;
import github.popeen.booksonic.util.LoadingTask;
import github.popeen.booksonic.util.Pair;
import github.popeen.booksonic.util.SilentBackgroundTask;
import github.popeen.booksonic.util.TabBackgroundTask;
import github.popeen.booksonic.util.Util;
import github.popeen.booksonic.view.FastScroller;
import github.popeen.booksonic.view.GridSpacingDecoration;
import github.popeen.booksonic.view.MyLeadingMarginSpan2;
...
import static github.popeen.booksonic.domain.MusicDirectory.Entry;
...
public class SelectDirectoryFragment extends SubsonicFragment implements SectionAdapter.OnItemClickedListener<Entry> {
	...
	public void unstarSelected() {
		List<MusicDirectory.Entry> selected = getSelectedEntries();
		if(selected.size() == 0) {
			selected = entries;
		}
		if(selected.size() == 0) {
