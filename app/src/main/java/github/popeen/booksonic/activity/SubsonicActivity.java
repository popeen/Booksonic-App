...
import github.popeen.booksonic.service.HeadphoneListenerService;
import github.popeen.booksonic.service.MusicService;
import github.popeen.booksonic.service.MusicServiceFactory;
import github.popeen.booksonic.updates.UpdateApp;
	...
	private static class SubsonicUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
		...
		public void uncaughtException(Thread thread, Throwable throwable) {
			...
			try {
				...
				PackageInfo packageInfo = context.getPackageManager().getPackageInfo("github.popeen.booksonic.dsub", 0);
