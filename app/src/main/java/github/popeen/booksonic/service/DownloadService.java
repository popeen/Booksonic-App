...
import static github.popeen.booksonic.domain.PlayerState.COMPLETED;
import static github.popeen.booksonic.domain.PlayerState.DOWNLOADING;
import static github.popeen.booksonic.domain.PlayerState.IDLE;
import static github.popeen.booksonic.domain.PlayerState.PAUSED;
import static github.popeen.booksonic.domain.PlayerState.PAUSED_TEMP;
import static github.popeen.booksonic.domain.PlayerState.PREPARED;
import static github.popeen.booksonic.domain.PlayerState.PREPARING;
import static github.popeen.booksonic.domain.PlayerState.STARTED;
import static github.popeen.booksonic.domain.PlayerState.STOPPED;
import static github.popeen.booksonic.domain.RemoteControlState.LOCAL;

import github.popeen.booksonic.audiofx.AudioEffectsController;
import github.popeen.booksonic.audiofx.EqualizerController;
import github.popeen.booksonic.domain.MusicDirectory;
import github.popeen.booksonic.domain.RepeatMode;
import github.popeen.booksonic.util.ArtistRadioBuffer;
import github.popeen.booksonic.util.Constants;
import github.popeen.booksonic.util.Notifications;
import github.popeen.booksonic.util.SilentBackgroundTask;
import github.popeen.booksonic.util.SimpleServiceBinder;
import github.popeen.booksonic.util.Util;
import github.popeen.booksonic.util.compat.RemoteControlClientHelper;
import github.popeen.booksonic.util.tags.BastpUtil;
import github.popeen.booksonic.dsub.R;
import github.popeen.booksonic.domain.Bookmark;
import github.popeen.booksonic.domain.PlayerState;
import github.popeen.booksonic.domain.PodcastEpisode;
import github.popeen.booksonic.domain.RemoteControlState;
import github.popeen.booksonic.domain.ServerInfo;
import github.popeen.booksonic.receiver.MediaButtonIntentReceiver;
import github.popeen.booksonic.util.MediaRouteManager;
import github.popeen.booksonic.util.ShufflePlayBuffer;
...
public class DownloadService extends Service {
	...
	public static final String CMD_PLAY = "github.popeen.booksonic.dsub.CMD_PLAY";
	public static final String CMD_TOGGLEPAUSE = "github.popeen.booksonic.dsub.CMD_TOGGLEPAUSE";
	public static final String CMD_PAUSE = "github.popeen.booksonic.dsub.CMD_PAUSE";
	public static final String CMD_STOP = "github.popeen.booksonic.dsub.CMD_STOP";
	public static final String CMD_PREVIOUS = "github.popeen.booksonic.dsub.CMD_PREVIOUS";
	public static final String CMD_NEXT = "github.popeen.booksonic.dsub.CMD_NEXT";
	public static final String CANCEL_DOWNLOADS = "github.popeen.booksonic.dsub.CANCEL_DOWNLOADS";
	public static final String START_PLAY = "github.popeen.booksonic.dsub.START_PLAYING";
